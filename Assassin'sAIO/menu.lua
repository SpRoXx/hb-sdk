...
if player.charName == "Akali" then
    champmenu.akalimenu = menu("AIO" .. player.charName, "Assassin - ".. player.charName);
    --Combo
...
if player.charName == "Katarina" then
    champmenu.katarinamenu = menu("AIO" .. player.charName, "Assassin - ".. player.charName);
...
if player.charName == "Talon" then
    champmenu.talonmenu = menu("AIO" .. player.charName, "Assassin - ".. player.charName);
...
if player.charName == "Leblanc" then
    champmenu.leblancmenu= menu("AIO" .. player.charName, "Assassin - ".. player.charName);
...
if player.charName == "Ekko" then
    champmenu.ekkomenu = menu("AIO" .. player.charName, "Assassin - ".. player.charName);
end
if player.charName == "Kassadin" then
    champmenu.kassadinmenu = menu("AIO" .. player.charName, "Assassin - ".. player.charName);
end
if player.charName == "Khazix" then
    champmenu.kahzixmenu = menu("AIO" .. player.charName, "Assassin - ".. player.charName);
end
if player.charName == "Rengar" then
    champmenu.rengarmenu = menu("AIO" .. player.charName, "Assassin - ".. player.charName);
...
if player.charName == "Evelynn" then
    champmenu.evellynmenu = menu("AIO" .. player.charName, "Assassin - ".. player.charName);
end
if player.charName == "Qiyana" then
    champmenu.qiyananmenu = menu("AIO" .. player.charName, "Assassin - ".. player.charName);
    --Primority
